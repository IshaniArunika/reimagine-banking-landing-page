...
const agendaData = [
  ...
  },
  {
    ...
    description:
      "Narendra Mistry, Shehab Moustafa, Matthew Hughes, Emad Shawky Habib Hanna",
  },
  {
    time: "01:00 PM",
    title:
...
const Agenda = () => {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-cover bg-center filter blur-xl opacity-40"
        style={{
          backgroundImage:
      ...
      <div className="grid gap-6 max-w-4xl mx-auto relative z-10">
        {agendaData.map((item, index) => (
          <div
            key={index}
            className="flex items-start gap-6 bg-white shadow-md rounded-2xl p-6"
          >
            <div className="text-purple-600 text-lg font-bold min-w-[8rem]">
              {item.time}
            </div>
